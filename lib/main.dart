import 'package:cyberspace/screens/home/homePage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: HomePage.routeName,//AddMatch.routeName,//'/splash', '/createTournament',
      routes: {
        HomePage.routeName: (context) => HomePage(),
        WalletPage.routeName: (context) => WalletPage(),
        SendMoneyPage.routeName: (context) => SendMoneyPage(),
        PieChatPage.routeName: (context) => PieChatPage(),
